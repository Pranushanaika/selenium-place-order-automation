...
public class Firstproject {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		String productName = driver.findElement(By.tagName("h3")).getText();
...
//		System.out.println("Second Product Name: " + secondProductName);
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", viewBasket);
				...
				String price = driver.findElement(By.cssSelector("span.woocommerce-Price-amount.amount")).getText();
...
//		        Thread.sleep(2000); 
//		        
//		        String basketTotal = driver.findElement(By.cssSelector(".order-total .amount")).getText();
//		        System.out.println("Updated Basket Total: " + basketTotal);
//		     
...
//
//		        // Verify that basket total matches checkout total
...
//
//		        // Compare with basket total
//		        if (basketTotal.equals(checkoutTotal)) {
//		            System.out.println(" Total matches between Basket and Checkout: " + checkoutTotal);
//		        } else {
//		            System.out.println("❌ Total mismatch! Basket: " + basketTotal + ", Checkout: " + checkoutTotal);
//		        }
		...
		// ================= STATE =================
			...
			// Wait a bit for state to load (important after country selection)
			Thread.sleep(2000);
			...
			WebElement placeOrder = wait.until(
				...
				// small wait to avoid overlay issues
				Thread.sleep(1000);
